...
jLoga is a log analyzer, optimized for performance, written in [java 21](https://openjdk.java.net/projects/jdk/21/) and capable to open huge files.
...
For each jloga variant Java 21 or later is required, you can download OpenJDK jre available from [Adoptium](https://adoptium.net/releases.html?variant=openjdk21&jvmVariant=hotspot), search it from [Oracle's java.com](https://java.com/it/download/) or use the one bundled with your operating system if any.
